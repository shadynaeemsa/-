...
client.channels.find('id', '423934297376817172').setName("༺Welcome To E");
client.channels.find('id', '423934297376817172').setName("༺Welcome To EG");
client.channels.find('id', '423934297376817172').setName("༺Welcome To EGY");
client.channels.find('id', '423934297376817172').setName("༺Welcome To EGYP");
client.channels.find('id', '423934297376817172').setName("༺Welcome To EGYPT");
client.channels.find('id', '423934297376817172').setName("༺Welcome To EGYPT༻");
client.channels.find('id', '423934297376817172').setName("༺Welcome To EGYPT༻:rose:");
client.channels.find('id', '423934297376817172').setName("༺Welcome To EGYPT༻:rose:");
client.channels.find('id', '423934297376817172').setName("༺Welcome To EGYPT༻:rose:");
  }, 3000);
});
